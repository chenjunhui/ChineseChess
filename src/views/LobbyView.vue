        ...
        <div class="help-section">
          ...
          <div v-if="showHelp" class="help-content">
            <div class="help-item">
              <h3>游戏模式</h3>
              <ul>
                <li><b>多人对战</b>：两位玩家各坐一方，实时 WebSocket 对弈</li>
            ...
            <div class="help-item">
              <h3>如何开始</h3>
              <p><b>多人对战</b>：两位玩家分别选择不同桌子的红方和黑方入座，两人坐满后自动开始。</p>
            ...
            <div class="help-item">
              <h3>操作按钮</h3>
              <ul>
                <li><b>悔棋</b>：撤回上一步操作（多人模式需对方同意）</li>
                <li><b>重新开始</b>：重新开局（多人模式需对方同意）</li>
                <li><b>离开对局</b>：返回大厅（多人对战中离开将判负）</li>
              </ul>
            </div>
          </div>
        </div>
